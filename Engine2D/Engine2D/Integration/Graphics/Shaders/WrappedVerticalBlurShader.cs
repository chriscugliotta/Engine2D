...
namespace Engine2D
{
  // A wrapped VerticalBlur.fx file
  public class WrappedVerticalBlurShader : WrappedShader
  {
    // =====
    #region Variables
    ...
    private Effect effect = Globals.Game1.Content.Load<Effect>("Shaders/VerticalBlur");
    ...
    public Matrix ActiveView
    {
      get
      {
        return WrappedVerticalBlurShader.activeView;
      }
      set
      {
        ...
        // Set local value
        WrappedVerticalBlurShader.activeView = value;
      }
    }
    ...
    public Matrix ActiveProjection
    {
      get
      {
        return WrappedVerticalBlurShader.activeProjection;
      }
      set
      {
        // Skip if already active
        ...
        // Set local value
        WrappedVerticalBlurShader.activeProjection = value;
      }
    }
    ...
    public WrappedTexture ActiveTexture
    {
      get
      {
        return WrappedVerticalBlurShader.activeTexture;
      }
      set
      {
        // Skip if already active
        ...
        // Set local value
        WrappedVerticalBlurShader.activeTexture = value;
      }
    }
    // activeHeight accessor
    public int ActiveHeight
    {
      get
      {
        return WrappedVerticalBlurShader.activeHeight;
      }
      set
      {
        // Skip if already active
        if (value == this.ActiveHeight) { return; }
        // Set effect value
        this.Effect.Parameters["height"].SetValue(value);
        // Set local value
        WrappedVerticalBlurShader.activeHeight = value;
      }
    }
    ...
    public int ActiveSampleSize
    {
      get
      {
        return WrappedVerticalBlurShader.activeSampleSize;
      }
      set
      {
        // Skip if already active
        ...
        // Set local value
        WrappedVerticalBlurShader.activeSampleSize = value;
      }
    }
    ...
    public float[] ActiveOffsets
    {
      get
      {
        return WrappedVerticalBlurShader.activeOffsets;
      }
      set
      {
        // Skip if already active
        ...
        // Set local value
        WrappedVerticalBlurShader.activeOffsets = value;
      }
    }
    ...
    public float[] ActiveWeights
    {
      get
      {
        return WrappedVerticalBlurShader.activeWeights;
      }
      set
      {
        // Skip if already active
        ...
        // Set local value
        WrappedVerticalBlurShader.activeWeights = value;
      }
    }
    ...
    public static WrappedVerticalBlurShader Gaussian(int sampleSize, float sigma)
    {
      // Entry logging
      ...
      // Return result
      return new WrappedVerticalBlurShader(sampleSize, offsets, weights);
    }

    // Designated constructor
    public WrappedVerticalBlurShader(int sampleSize, float[] offsets, float[] weights)
    {
      // Get ID
      this.id = nextID++;
    ...
    public override void PassParameters()
    {
      ...
      this.ActiveHeight = Globals.GraphicsDevice.ActiveTexture.Height;
